...
table <- read.table("C:/Users/njc232/OneDrive - University of Exeter/Documents/MatchedResults_2004_2014_V2/Joshua_cumulative_matched_data.txt", header = TRUE, sep = "\t") 
...
ggsurv$plot <- ggsurv$plot + ggtitle("2004 - 2014")
...
ggsurv <- ggsurvplot(
  ...
  tables.theme = theme_cleantable(),
  pval.size = 5,  # Set the size of the p-value text
  pval.coord = c(0.2, 5)  # Adjust the position of the p-value text
)
ggsurv$plot <- ggsurv$plot + ggtitle("2004 - 2014: Under 75 Age Group")
print(ggsurv)
