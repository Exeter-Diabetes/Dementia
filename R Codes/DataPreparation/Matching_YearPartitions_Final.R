...
sink("C:/Users/njc232/OneDrive - University of Exeter/Documents/MatchedData_exact_final/summary_output.txt", append = TRUE)
...
for (year in 2004:2023) {
  ...
  combined_data <- result2 %>%
    ...
    mutate(
      # ONS_stroke_post = if_else(
      #   is.na(stroke_composite_post_index_date) & !is.na(stroke_date_of_death), 1, 0),
      # 
      ...
      # # Update stroke_compositeDate_post_first_stroke if prescibed other drugs within a year
      # stroke_compositeDate_post_first_stroke = as.Date(ifelse(
      #   !is.na(earliest_other_antipsychotic_date_post_R_prescription) & 
      #     stroke_compositeDate_post_first_stroke >= earliest_other_antipsychotic_date_post_R_prescription & 
      #     stroke_compositeDate_post_first_stroke <= censoringDate,
      #   NA,
      #   stroke_compositeDate_post_first_stroke
      # )
      # ),
      # 
      # # Update stroke_composite_post_index_date if prescibed other drugs within a year
      # stroke_composite_post_index_date = ifelse(
      #   !is.na(earliest_other_antipsychotic_date_post_R_prescription) & 
      #     stroke_compositeDate_post_first_stroke >= earliest_other_antipsychotic_date_post_R_prescription & 
      #     stroke_compositeDate_post_first_stroke <= censoringDate,
  ...
  # pdf(paste0("C:/Users/njc232/OneDrive - University of Exeter/Documents/MatchedData_exact_final/plot_", year, ".pdf"), width = 10, height = 8) 
  # 
  ...
  write.table(match.t, file = paste0("C:/Users/njc232/OneDrive - University of Exeter/Documents/MatchedData_exact_final/match_t_", year, ".txt"), sep = "\t", row.names = FALSE)
  # Save matched data to the list
  file_name <- paste0("C:/Users/njc232/OneDrive - University of Exeter/Documents/MatchedData_exact_final/matched_data_iteration_", year, ".txt")
...
write.table(all_matched_data, "C:/Users/njc232/OneDrive - University of Exeter/Documents/MatchedData_exact_final/Joshua_all_matched_data.txt", sep = "\t", row.names = FALSE)
...
write.table(cumulative_matched_data, file = "C:/Users/njc232/OneDrive - University of Exeter/Documents/MatchedData_exact_final/Joshua_cumulative_matched_data.txt",sep = "\t", row.names = FALSE)
